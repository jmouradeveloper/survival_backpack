class SupplyRotationsController < ApplicationController
  ...
  def new
    @supply_rotation = SupplyRotation.new
  ...
  def create
    @supply_batch = SupplyBatch.find(supply_rotation_params[:supply_batch_id])
  ...
  def statistics
    ...
    @food_item = FoodItem.find(params[:food_item_id]) if params[:food_item_id].present?
